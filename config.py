...
my_custom_dataset = dataset_base.copy({
    ...
    'train_images': './data/unet-testdata-480-300/coco-480-300/images/',
    'train_info':   './data/unet-testdata-480-300/coco-480-300/annotations/segments.json',

    'valid_images': './data/unet-testdata-480/coco-480/images/',
    'valid_info':   './data/unet-testdata-480/coco-480/annotations/segments.json',

    'has_gt': True,
    'class_names': ('Block', 'Line', 'Dot', ...)
})
